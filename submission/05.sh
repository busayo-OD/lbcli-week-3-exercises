...
# Decode the raw transaction to extract txid and vout
DECODED_TX=$(bitcoin-cli -regtest decoderawtransaction "$RAW_TX")

# Extract txid and vout from the decoded transaction
